...
class Calculator {
  ...
  initializeCalculator() {
    ...
    this.removeLastCharBtn = document.querySelector(
      this.UiSelectors.actionBtns.remove
    )
  ...
  addListeners() {
    ...
    this.removeLastCharBtn.addEventListener("click", () =>
      this.removeLastChar()
    )
  }
  ...
  removeLastChar() {
    this.displayResult.value = this.displayResult.value.substring(
      0,
      this.displayResult.value.length - 1
    )
  }
